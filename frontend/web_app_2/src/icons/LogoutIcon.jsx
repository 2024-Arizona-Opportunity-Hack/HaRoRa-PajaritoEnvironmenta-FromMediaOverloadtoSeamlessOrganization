export default function LogoutIcon(){
  return (
    <svg className='h-6 w-6 hover:cursor-pointer hover:scale-105 active:scale-95' xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
