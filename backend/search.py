...
class SearchArgs(BaseModel):
    ...
    tags: list[str] = Field(desc='give list of tags that should be searched in the DB based on the user query and image provided. Can return empty list too', max_length=20)
